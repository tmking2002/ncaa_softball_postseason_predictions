...
matchup <- data.frame(away_team = "Stanford", away_starting_pitcher = "Canady, NiJaree",
                      home_team = "Oklahoma", home_starting_pitcher = "Bahl, Jordyn")
...
matchup <- data.frame(away_team = "Alabama", away_starting_pitcher = "Fouts, Montana",
...
matchup <- data.frame(away_team = "Oklahoma St.", away_starting_pitcher = "Maxwell, Kelly",
                      home_team = "Florida St.", home_starting_pitcher = "Sandercock, Kathryn")
...
matchup <- data.frame(away_team = "Utah", away_starting_pitcher = "Lopez, Mariah",
